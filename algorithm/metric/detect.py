...
def detectOnline(threadName: str, detectParam: dict, detectionTask: DetectionTask):
    ...
    # 加载的模型
    load_model, load_podNames, load_metricNames, load_threshold = saveModelUtil.loadModelByName(detectParam["modelName"])
    # 搜集预测的数据
    metricMap = PROMETHEUS.getMetrics(load_metricNames, startTime=detectionTask.startTime, endTime=detectionTask.endTime)
